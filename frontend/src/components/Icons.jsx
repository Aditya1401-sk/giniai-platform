...
const createIcon = (paths, defaultViewBox = "0 0 24 24") => {
...
export const IconBadgeCheck = createIcon(
  <>
...
export const IconFingerprint = createIcon(
  <>
    ...
    <path d="M5 19.5C5.5 18 6 15 6 11.5a6 6 0 0 1 12.01-.16" />
    <path d="M8.6 15c.6-3 3-5 5.4-5s4.8 2 5.4 5" />
    <path d="M12 18v-3" />
    <path d="M15 22v-3" />
  </>
);
